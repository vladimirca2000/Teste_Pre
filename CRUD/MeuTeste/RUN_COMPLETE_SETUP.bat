@echo off
REM ============================================================================
REM SCRIPT COMPLETO PARA SETUP E EXECU��O - BACKEND E FRONTEND
REM ============================================================================
REM Autor: GitHub Copilot
REM Data: 2026-01-08
REM Descri��o: Gerencia a execu��o do Backend e Frontend em sequ�ncia
REM ============================================================================

setlocal enabledelayedexpansion

REM ============================================================================
REM CONFIGURA��O INICIAL
REM ============================================================================
...
REM ============================================================================
REM FUN��O: EXIBIR MENU PRINCIPAL
REM ============================================================================
:MENU_PRINCIPAL
cls
echo.
...
REM ============================================================================
REM OP��O 1: EXECUTAR BACKEND + FRONTEND (SEQUENCIAL)
REM ============================================================================
...
REM ============================================================================
REM OP��O 4: TESTAR BACKEND COM CURL
REM ============================================================================
:TEST_BACKEND
cls
echo.
...
cls
echo.
echo ??  Este teste requer um token JWT v�lido
echo.
set /p token="Cole o token JWT (ou pressione ENTER para usar um token de teste): "
if "%token%"=="" (
    echo.
    echo Usando teste sem autentica��o...
...
REM ============================================================================
REM OP��O 5: LIMPAR node_modules E REINSTALAR
REM ============================================================================
:CLEAN_INSTALL
cls
echo.
